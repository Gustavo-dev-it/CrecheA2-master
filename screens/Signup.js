...
const Signup = ({ navigation }) => {
    ...
    const validationSchema = yup.object().shape({
        ...
        cep: yup.string().required('Campo obrigatório').min(9, 'CEP inválido'),
    ...
    const fetchAddressByCep = async (cep) => {
        try {
            ...
            if (!data.erro) {
                formik.setFieldValue('responsibleAddress', `${data.logradouro}, ${data.bairro}, ${data.localidade} - ${data.uf}`);
            }
        } catch (error) {
        ...
        <SafeAreaView style={{ flex: 1, backgroundColor: COLORS.white }}>
            ...
            >
                ...
                <View style={{ flex: 1, marginHorizontal: 22 }}>
                    ...
                    <View style={[styles.inputContainer, { borderColor: touchedFields.cep ? (formik.values.cep ? COLORS.grey : 'red') : COLORS.grey }]}>
                        <TextInputMask
                            type={'zip-code'}
                        ...
                        />
                        {loadingCep && <Ionicons name="search" size={20} color={COLORS.grey} />}
                        {touchedFields.cep && formik.errors.cep && (
                            <Text style={{ color: 'red' }}>{formik.errors.cep}</Text>
                        )}
                    </View>
                    ...
                    <View style={[styles.inputContainer, { borderColor: touchedFields.responsibleAddress ? (formik.values.responsibleAddress ? COLORS.grey : 'red') : COLORS.grey }]}>
                        <TextInput
                            ...
                            value={formik.values.responsibleAddress}r
                        />
